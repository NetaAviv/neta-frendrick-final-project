...
DATABASE = {
    ...
    'PASSWORD': 'Aa123456',           # PostgreSQL password
    'HOST': 'neta-fred-database.cx248m4we6k7.us-east-1.rds.amazonaws.com',      # Database server
...
REDIS = {
    'tasks': {
        'HOST': 'neta-fred-redis-7fftml.serverless.use1.cache.amazonaws.com',
        'PORT': 6379,
...
SECRET_KEY = 'E)Vjq$&l7I&k77289UAT&7-q@z*XCr3@7y*9#A91u2-FW(%-Xo'
